...
export default function zhipuProvider(pi: ExtensionAPI) {
  ...
  pi.registerProvider("zhipu", {
    ...
    models: [
      // ═══════════════════════════════════════════════════════════════════
      // ANTHROPIC API (Flagship / Coding models)
      // Endpoint: https://open.bigmodel.cn/api/anthropic/v1/messages?beta=true
      // ═══════════════════════════════════════════════════════════════════
      {
        id: "glm-5.1",
        name: "GLM-5.1",
      ...
      },
      {
        ...
        input: ["text"],
        cost: { input: 12, output: 50, cacheRead: 0, cacheWrite: 0 },
        contextWindow: 200000,
        maxTokens: 128000,
        headers: {
          "anthropic-beta": "true",
      ...
      },
      {
        ...
        input: ["text"],
        cost: { input: 10, output: 40, cacheRead: 0, cacheWrite: 0 },
        contextWindow: 200000,
        maxTokens: 128000,
        headers: {
          "anthropic-beta": "true",
